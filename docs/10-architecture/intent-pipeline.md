...
These are **internal deterministic derivations** over derived State. They do **not** require separate canonical **Event** types unless the System explicitly requires records for replay or audit ([Terminology: Intent visibility](../00-guides/terminology.md#intent-visibility)).

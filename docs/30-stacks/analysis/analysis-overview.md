...
- Producing **derived analytical artifacts** — comparative evaluations, analysis datasets, reports, and versioned results that become part of the Infrastructure's persistent record.

...
**Implementation choices, not canonical semantics.** The metadata model, workflow patterns, orchestration tooling, and pipeline decomposition described here are realization concerns. They do not define or modify the System's canonical Event, State, or lifecycle semantics.

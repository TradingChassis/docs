...
The Data Recording Stack receives **raw market-data feed messages** from real Venues. These are external data sources outside the System boundary.
...
Venues are external market-data sources outside the System boundary. The Data Recording Stack connects to Venue market-data feeds to receive raw messages.
